...
const MillieInput = forwardRef<HTMLInputElement, Props>(
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          {...props}
          className={[
            "w-full border border-bege-escuro/40 bg-roxo-escuro/80 px-3 py-2.5",
...
MillieInput.displayName = "MillieInput";
export default MillieInput;